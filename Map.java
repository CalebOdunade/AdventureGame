...
private Room[][] myMap;
	...
	public void displayFancyMap(int playerX, int playerY) {
		 if (playerY == 0 && playerX == 0) {
	            ...
	            System.out.println("___________:__________:__________: _ _ _ _ _/");
	            System.out.println("/          /          :          /          /");
	            System.out.println("/          /          :          /          /");
	            System.out.println("/          /          :          /          /");
	            System.out.println(" _ _ _ _ _ / _ _ _ _ _:__________/ _ _ _ _ _/");
	            System.out.println("/          /          :          :          /");
	            System.out.println("/          /          :          :          /");
	            System.out.println("/          /          :          :          /");
	            System.out.println("/ _ _ _ _ _/ _ _ _ _ _:__________:__________/");
	            System.out.println("/          :          :          :          /");
	            System.out.println("/          :          :          :          /");
	            System.out.println("/          :          :          :          /");
	            System.out.println("______________________________________________");
	        } else if (playerY == 1 && playerX == 0) {
	            System.out.println("_____________________________________________");
	            System.out.println("/          :    You   :          :          /");
	            System.out.println("/          :    Are   :          :          /");
	            System.out.println("/          :    Here  :          :          /");
	            ...
	            System.out.println("/          /          :          :          /");
	            System.out.println("/          /          :          :          /");
	            System.out.println("/ _ _ _ _ _/ _ __ _ _ :__________:__________/");
	            System.out.println("/          :          :          :   You    /");
	            System.out.println("/          :          :          :   Are    /");
	            System.out.println("/          :          :          :   Here   /");
	            System.out.println("______________________________________________");	
		...
		case 0:
			...
			case 0:
				return new Room("FOREST TRAIL:\nYou are standing on a dirt trail that leads to the east. Surrounding you is the famously thick underbrush\n" +
						...
						"Off in the distance you hear the cool sounds of Lake Herrick drifting through the trees. \nTYPE \"HELP\" FOR INSTRUCTIONS",false,false,true,false,false,null,null,null);
			case 1:
				return new Room("WOODEN WALKWAY:\n"
						+ "The wooden walkway makes a clump as you stride along it, the sound echoing through the dim surroundings. \n" + "An old, unlit" +
						"lamp hangs nearby, its presence a silent reminder of the approaching nightfall." + "A mountain biker,\n" + "ignoring the many \"Fragile Habitat\" " + 
						"signs, speeds along a narrow dirt path to your right. As you reach the end\nof the walkway," + "the shadow of the unlit "
								+ "lamp stretches over a hole in the ground, where a newly fallen tree has \nleft a footprint just large enough for you to fit through.",false,false,true,true,false,new Lamp(),null,null);
			case 2:
			...
			case 0:
				return new Room("RESEARCH PLATFORM:\nYou have come across an old research platform, apparently built by researchers.  A layer of dust\n" +
						...
						"You find a notebook full of undecipherable writings and alien drawings, forever faded by the mists of time. (and caves are wet, too)\n" +
						 "As you step closer to the table, something catches your eye a small, rusty key lying on the floor, half buried under layers of dust.\n"
						+ "It looks old, as if it hasn’t been touched in years, but something about it tells you it might fit into a lock somewhere on this platform.",false,true,true,false,true,null,theKey,null);
			case 1:
		...
		case 3:
			...
			case 3:
				theChest.setContents("The chest lid is heavy, and you strain to open it.  It finally creaks open with a loud CREAK.\n\nYou peer inside, lifting the lamp gently, and find ..." +
						...
						"into the most beautiful thing you've ever seen.  Seriously this thing cannot be described with words:  it's oblongedlo shaped, with wings coming\n" +
